      ...
      <v-col>
        <div flat>
          <v-row align="center" justify="space-between">
            <v-col class="py-0">
              <div class="title d-flex flex-row">
                ...
                <div>Data Pengeluaran Khusus</div>
              </div>
            </v-col>
          ...
          <v-row>
            ...
            <v-col cols="4" class="py-0">
              <div class="d-flex flex-row align-center mb-1">
                <div class="font-md mb-1">Departemen Office (Khusus)</div>
              </div>
              <div class="d-flex flex-row align-center mb-1">
...
export default {
  ...
  methods: {
    ...mapActions([
      "pengeluaranDetailOfficeKhusus",
      "pengeluaranDepartemenOfficeKhusus",
    ]),
    formatPrice(value) {
    ...
    openDetail(pengeluaran) {
      ...
      this.pengeluaranDetailOfficeKhusus(param);
      // console.log(param)
    },
    getPengeluaranMonth() {
      console.log(this.getMonth);
          ...
          this.pengeluaranDepartemenOfficeKhusus({
